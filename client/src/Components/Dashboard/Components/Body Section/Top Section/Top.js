        ...
        <div className="topSection">
            ...
            <div className="cardSection flex">
                <div className="rightCard flex">
                    ...
                    <p>
                        The world's fast growing industry today are natural made
                        products!
                    </p>
                ...
                <div className="leftCard flex">
                    <div className="main flex">
                        ...
                        <div className="imgDiv">
                            <img src={img2} alt="Image_Name" />
                        </div>
                    </div>

                    {/* We shall use this card letter */}
                    <div className="sideBarCard">
                        ...
                        <div className="cardContent">
                            ...
                            <h3> Help Center</h3>
                            <p>
                                Having trouble in Planti, please contact us from
                                for mor questions.
                            </p>
